    ...
    if (isset($_POST['easypaisa'])) {
        ...
        if (isset($_FILES["file"]) && $_FILES["file"]["error"] === UPLOAD_ERR_OK) {
            ...
            $sql = "INSERT INTO easypaisa (order_id,username, email, phone, total_payment, image) VALUES (?, ?,?, ?, ?, ?)";
            $stmt = mysqli_prepare($conn, $sql);

            // Bind parameters
            mysqli_stmt_bind_param($stmt, "ssssis", $_POST['order_id'], $_POST['username'], $_POST['email'], $_POST['phone'], $_POST['total_payment'], $filename);
    ...
    if (isset($_POST['stripe'])) {
        ...
        if (isset($_FILES["file"]) && $_FILES["file"]["error"] === UPLOAD_ERR_OK) {
            ...
            // Use prepared statements to prevent SQL injection
            $sql = "INSERT INTO stripe (order_id,username, card_num, expiry, total_payment, image) VALUES (?, ?, ?, ?, ?, ?)";
            $stmt = mysqli_prepare($conn, $sql);

            // Bind parameters
            mysqli_stmt_bind_param($stmt, "ssssis", $_POST['order_id'], $_POST['username'], $_POST['card_num'], $_POST['expiry'], $_POST['total_payment'], $filename);
    ...
    <style>
        ...
        .selected {
            ...
            /* Example: Add your desired visual indication here */
        ...
        <div class="row">
            ...
            <div class="col-lg-9 m-auto card card-shadow">
                ...
                <div class="row text-center">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group pb-3" id="showeasypaisa">



                                <form action="" method="post" enctype="multipart/form-data">
                                    <br>
                                    <input type="text" class="form-control " id="exampleInputEmail1" value="<?php echo '034455667789' ?>" readonly>
                                    <span class="mb-0 pb-0 text-secondary" style="text-align: left;"><small>
                                            <p>Here is the Easypaisa number where you send charges</p>
                                        </small></span>

                                    <input type="text" class="form-control" name="order_id" id="exampleInputEmail1" value="<?php echo $id; ?>" readonly><br>

                                    <input type="text" class="form-control" name="username" id="exampleInputEmail1" value="<?php echo $username; ?>" readonly><br>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group" id="showstripe">
                                ...
                                <input type="text" class="form-control " id="exampleInputEmail1" value="<?php echo '3412545649109' ?>" readonly>
                                    <span class="mb-0 pb-0 text-secondary" style="text-align: left;"><small>
                                            <p>Here is the Account number where you send charges</p>
                                        </small></span>
                                    <input type="text" class="form-control" name="order_id" id="exampleInputEmail1" value="<?php echo $id; ?>" readonly><br>
